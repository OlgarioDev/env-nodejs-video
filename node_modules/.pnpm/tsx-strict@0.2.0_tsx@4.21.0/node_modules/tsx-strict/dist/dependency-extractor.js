...
function extractDependencies(content, currentFile) {
    const dependencies = [];
...
function getAllDependencies(entryFile, options = {}) {
    const { extensions = [".js", ".jsx", ".ts", ".tsx", ".mjs", ".cjs"], exclude = /node_modules/, maxDepth = Infinity, } = options;
